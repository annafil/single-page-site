  ...
  <div class="navbar navbar-default navbar-static-top" role="navigation">
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav" id="main-menu">
            ...
            <li><a href="#page-profile">tl;dr</a></li>
            <!--<li><a href="#page-education">Research</a></li>
            <li><a href="#page-experience">Practice</a></li>
        ...
        <div class="container">
            <div class="row">
                <header class="centered">
                    <h1>Anna Filippova</h1>
                    <p>PhD Candidate. Organisational Hacker. Nerd.</p>
                </header>
                <div class="social-icons">
                        <a href="https://twitter.com/anna_fil" class="btn btn-round btn-clear btn-twitter"><i class="fa fa-twitter"></i></a>
                        <!--<a href="https://www.facebook.com/filippova.anna" class="btn btn-round btn-clear btn-facebook"><i class="fa fa-facebook"></i></a>
                        ...
                        <a href="https://www.linkedin.com/in/annafilippova" class="btn btn-round btn-clear btn-linkedin"><i class="fa fa-linkedin-square"></i></a>
                        <a href="https://www.github.com/annafil/" class="btn btn-round btn-clear btn-github"><i class="fa fa-github"></i></a>
                ...
                <a href="#page-contact" class="btn btn-default hire-me">Get in Touch</a></a>
            </div>
        </div>
    ...
    <section id="page-profile" class="page-profile">
      <div class="container">
            ...
            <div class="row">
              <div class="col-md-3">
                 <div class="profile"><img src="img/me.jpg" alt="profile"/></div> 
              </div>
               <div class="col-md-9">
                <p>When I'm not working on my dissertation, I teach and I tinker.</p>
                <p>Ask me about distributed work, Free Software, stats or privacy. </p>
                <p>I also have opinions on education, giving access to technology through open software and hardware, and the correct ending to Battlestar Galactica.</p>
                <p>I'm a recent Rails convert, but I also grok Python and PHP. In my spare time, I learn new things and dance.</p>
              </div>
            </div>
      </div> 
       ...
       <div class="container">
                <header class="section-header">
                    <h2 class="section-title"><span>Research</span></h2>
                     <div class="spacer"></div>
                    <p class="section-subtitle">I'm interested in group psychology, conflict, Free Software and distributed work. </p>
                </header>
                <div class="row">
                 <div class="col-md-6">
                  <article class="education">
                    <header>
                      ...
                      <p><em>Doctor of Philosophy</em> - <strong>Expected Graduation:</strong> Early 2016</p>
                    </header>
                      <p>I aim to improve virtual team work by learning from Free and Open Source Software development practice. I examine how conflict emerges within projects, when it needs to be managed, and when it can be generative for the team. </p>
                      <p>Through a combination of in-depth interviews, machine learning and surveys I'm beginning to understand that virtual work requires a strong sense of common identity, while conflict drives project growth. </p>
                      <p>I'm grateful to the Free and Open Source Software community in Singapore for their support of this effort. </p>
                      <p>I've also done work on interpersonal privacy in socia media, the group psychology of file-sharing and crowdsourced collective memory archives.</p>
                  </article>
                </div>
                <div class="col-md-6">
                <article class="education">
                  <header>
                    ...
                    <p><strong>Filippova, A.</strong>, Cho, H. (2014) Below Boiling Point: Negotiating conflict thresholds in distributed work. <em> To be presented at the AoIR 2014 Annual Conference,</em> Daegu, Korea.</p>
                    <p>Cho, H., Chung, S., <strong>Filippova, A.</strong> (2013). Estimating the prevalence of digital piracy: An examination of interacting sources and effects on downloading behavior. <em>Paper presented at the ICA 2013 Annual Conference,</em> London, UK.</p>
                </article>
                </div>
            </div>
       </div>
    ...
    <!-- experience begins 
     <section id="page-experience" class="page-experience">
       <div class="container">
                <header class="section-header">
                    <h2 class="section-title"><span>Practice</span></h2>
                     <div class="spacer"></div>
                    <p class="section-subtitle">I also have experience teaching, building and leading. </p>
                </header>
                <div class="row">
                 <div class="col-md-4">
                  <article class="experience">
                    <header>
                      <h3>National University of Singapore</h3>
                      <p><em>Teaching Assistant</em> / Singapore / 2011 - Current</p>
                    </header>
                      <p>I've taught Quantitative Research Methods, Social Psychology of New Media, Intercultural Communication and an introductory course to New Media. </p>
                      <p>I've received several <a href="http://www.fas.nus.edu.sg/grad/gsta.html" target="_blank">faculty</a> and <a href="http://blog.nus.edu.sg/cnmblog/2014/07/17/cnm-homecoming-2014-2/">department</a> teaching awards for my work in Quantitative Research Methods in particular. </p>
                  </article>
                </div>
                  <div class="col-md-4">
                  <article class="experience">
                    <header>
                      <h3>Samonas Singapore</h3>
                       <p><em>Communications Manager / Singapore / 2009 - 2011</em></p>
                    </header>
                      <p></p>
                  </article>
                </div>
                ...
                <article class="experience">
                  <header>
                    <h3>PixelForte</h3>
                     <p><em>Free-lance Web Developer / Kuala Lumpur / 2005 - 2009</em></p>
                  </header>
                    <p>I've built numerous websites </p>
                </article>
                </div>
            </div>
        </div>
          ...
          <div class="container">
              <header class="section-header">
                  <h2 class="section-title"><span>Contact</span></h2>
                    <div class="spacer"></div>
                       <p class="section-subtitle">I'm always excited to hear about ways I can make a difference. </p>
              </header>
        <div class="row">
          <!--<div class="col-sm-5 contact-info">
            <h3>Contact Info</h3>
            <p> Department of Communications & New Media </p>
            <p> <em>National University of Singapore</em></p>
            <p><i class="fa fa-map-marker"></i> Blk AS6, #03-41 11 Computing Drive Singapore 117416</p>
            <p><i class="fa fa-phone"></i> (555) 123-4567 | (+65) 6779 4911 (FAX)</p>
            <p><i class="fa fa-envelope-o"></i> annafil@gmail.com</p>
          </div>
         -->
